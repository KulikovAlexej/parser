        ...
        try:
            ...
            if len(tds) == 6:
                return {
                    ...
                    'handicap': tds[3].string,
                    'team_1_odd': tds[4].get('data-odd'),
                    'team_2_odd': tds[5].get('data-odd'),
                    'team_1_date': tds[4].get('data-created'),
                    'team_2_date': tds[5].get('data-created'),
                }
...
for item in match_items:
    ...
    try:
        ...
        odds_hc = list(filter(lambda o: o is not None, map(extract_odds, trs)))
        ...
        try:
            connector.football_betexp_odds_hc.insert(entity)
